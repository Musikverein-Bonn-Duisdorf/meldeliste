...
Hier findest du Konzertaufnahmen, Fotos und weitere Medien für den internen Gebrauch:
  <div class="w3-container w3-row">
	...
	<button class="w3-btn w3-border w3-margin-top w3-border-black w3-col s12 m6 l4 <?php echo $GLOBALS['optionsDB']['colorBtnEdit'] ;?>" type="submit"><i class="fas fa-cloud"></i> Fotos</button>
    </form>
    <form action="https://cloud.musikverein-bonn-duisdorf.de/index.php/s/3nz6GTtJWCLESfx" target="_blank" method="POST">
	<button class="w3-btn w3-border w3-margin-top w3-border-black w3-col s12 m6 l4 <?php echo $GLOBALS['optionsDB']['colorBtnEdit'] ;?>" type="submit"><i class="fas fa-cloud"></i> Videos</button>
    </form>
  </div>
</div>
<?php
