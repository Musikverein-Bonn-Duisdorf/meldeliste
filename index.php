...
if($GLOBALS['optionsDB']['showAppmntPage']) {
    $more = new div;
    $more->tag="a";
    $more->class="w3-btn w3-hide-large w3-mobile w3-border w3-border-black";
    ...
    $moreL = new div;
    $moreL->tag="a";
    $moreL->class="w3-btn w3-hide-small w3-hide-medium w3-margin-left w3-padding w3-border w3-border-black";
