    ...
    <div class="w3-dropdown-content w3-bar-block w3-card-4 <?php echo $optionsDB['colorNavAdmin']; ?> w3-mobile">
      ...
      <div class="w3-dropdown-hover w3-mobile admin-nav-group">
        ...
        <div class="w3-dropdown-content w3-bar-block w3-card-4 <?php echo $optionsDB['colorNavAdmin']; ?> w3-mobile">
          ...
          <a title="Empfängergruppen" alt="Empfängergruppen" href="mail-groups.php" class="w3-bar-item w3-button w3-mobile <?php getAdminPage('mail-groups');?>"><i class="fas fa-users"></i> Empfängergruppen</a>
        </div>
      </div>
      <?php } ?>
