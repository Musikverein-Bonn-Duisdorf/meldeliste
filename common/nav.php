...
<?php } ?>
  ...
  <a title="Meine Nachrichten" alt="Meine Nachrichten" href="meine-mails.php" class="stdhide w3-hide-small w3-bar-item w3-button w3-mobile <?php getPage('meinemails');?>"><i class="fas fa-envelope"></i></a>
