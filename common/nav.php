<div class="w3-container <?php echo $optionsDB['colorTitle']; ?>">
  <h1 class="w3-hide-small" style="width: calc(100vw - 120px);"><?php echo $optionsDB['WebSiteName']; ?></h1>
  <h1 class="w3-hide-large w3-hide-medium" style="width: calc(100vw - 120px);"><?php echo $optionsDB['WebSiteNameShort']; ?></h1>
  <img src="imgs/Logo.png" style="max-height:100px; position: absolute; top: 10px; right: 10px;">
  <p><?php
