...
<p>Liegt ein Leihvertrag oder Rückgabeprotokoll zur Unterschrift, erscheint es oben unter <b>Zur Unterschrift</b>. Du unterschreibest im Popup (nur dein Feld; Ort, Datum und Uhrzeit werden automatisch ergänzt). Ist der Vertrag schon vom Verein unterschrieben, kannst du ihn auch vor Ort auf dem geöffneten Formular des Inventar-Admins unterschreiben. Fertig ist das Formular erst mit beiden Unterschriften; dann wird das fertige Formular wie ein Scan an der Leihe gespeichert und geht zusätzlich per Mail an dich. Bis dahin kannst du deine eigene Unterschrift wieder löschen. Drucken und Scannen bleiben daneben möglich. Das ist keine qualifizierte elektronische Signatur.</p>
'
    );
}
