...
<li>Bearbeiten, Löschen und Ausleihen nur mit Schreibrechten; im Inventar-Modal unter <b>Leihen</b> Person wählen und <b>Leihvertrag</b> (übrige Angaben optional bzw. im Formular) — der Vertrag öffnet sich; offene Leihen mit Datum und <b>Rückgabe</b> beenden (öffnet das Rückgabeprotokoll); Scans einzeln löschen oder den ganzen Leiheintrag entfernen</li>
<li><b>Leihvertrag / Rückgabe</b> – aus der Leihhistorie druckbare Formulare (alle Inventartypen); Leihbeginn, Leihende, Kaution und Leihgebühr im Formular änderbar und speicherbar; Kaution und Leihgebühr im Druck nur wenn &gt; 0 €; Entleiher immer so bezeichnet; Adresse und zusätzliche Vereinbarungen/Bemerkungen optional und jederzeit änderbar; Rückgabe-Checkliste online abhakbar und speicherbar; nach Unterschrift Scan (PDF, JPEG oder PNG) ablegen, öffnen oder löschen und neu hochladen. Bei Vereinsmitgliedern endet die Leihe mit dem Austritt, sonst neuer Vertrag als Nicht-Mitglied</li>
' : '').'
</ul>
'
);
