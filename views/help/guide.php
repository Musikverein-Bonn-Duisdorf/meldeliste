...
<li><b>Konfiguration</b> – Farben, Texte, Feature-Schalter, Webhooks, Default-Sichtbarkeit neuer Termine (<code>defaultTerminVisibility</code>), Leih- und Rückgabetexte (<code>loanClause…</code> / <code>loanReturn…</code>, Platzhalter wie <code>{org}</code> <code>{start}</code> <code>{amount}</code>), …; Änderungen erscheinen im Log</li>
