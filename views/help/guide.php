...
<ul>
<li><b>E-Mail</b> – Nachrichten per E-Mail (Mailverteiler / SMTP), wenn der Kanal aktiv ist und die Person im gewählten Verteiler liegt (Rollen/Register/Personen/Teilnehmer). Auch bei Gastmusikern (<b>aktiv</b> aus) setzbar – kein Register-Sammelversand, aber gezielte Auswahl im Mail-Formular</li>
...
'.(requirePermission('perm_editUsers') ? '<li><b>Musiker anlegen</b> – Person anlegen inkl. Benachrichtigungen, Haken <b>aktiv</b> (aus = Gastmusiker), Instrument, Gruppen-Chips und Rechte (persönlich editierbar; über Gruppen vererbte Rechte erscheinen mit gestricheltem Rahmen und sind hier nicht entfernbar); Gastmusiker können Kanal <b>E-Mail</b> trotzdem aktivieren (nur gezielter Verteiler, kein Register-Sammelversand); Mitgliedschaft wird in der Mitgliederverwaltung gepflegt; beim Bearbeiten bei Inventar-Recht (oder eigenes Profil) Eigentum und aktive Leihen als Inventar-Chips; <b>Deaktivieren</b> setzt Gastmusiker; <b>Löschen</b> prüft zuerst Inventar (Eigentum/aktive Ausleihe blockiert das Löschen mit Hinweis), entfernt danach zukünftige Meldungen/Schichtmeldungen und soft-löscht die Person – zurückliegende Meldungen bleiben für Statistik/Archiv; <b>Automatisch</b> zeigt die abgeleitete Zugehörigkeit</li>' : '').'
...
<p>Ist ein <b>Notenarchiv</b> angeschlossen, kannst du dem Termin unter <b>Programm</b> eine oder mehrere Archiv-Sammlungen zuordnen (Chip-Eingabe). In der Terminübersicht erscheint der Chip <b>Programm</b>; Klick öffnet die Stückliste wie im Archiv (Cover, Komponist, Arrangeur, Verlag, …). Ist im Archiv beim Stück eine <b>Aufnahme</b>-URL hinterlegt, öffnet das Play-Symbol oben rechts auf dem Cover die Aufnahme in einem neuen Tab.</p>
...
<li><b>Log</b> – Anwendungsprotokoll (Suche serverseitig; mehrere Wörter = UND, z. B. <code>ERROR Meier</code>; Live-Aktualisierung); Akteure und referenzierte User/Termine/Inventar/Emails/Schichten in der Nachricht als Chip öffnen das jeweilige Modal, sofern berechtigt; Chunk-Größe für Scroll und Live-Nachladen über <code>logListChunkSize</code>; DEBUG-Einträge (z. B. Webcal-Abrufe) nur bei aktiviertem <code>logDebug</code></li>
' : '').'
'.(requirePermission('perm_editConfig') ? '
