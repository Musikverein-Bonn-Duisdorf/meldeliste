...
<li>Bearbeiten, Löschen und Ausleihen nur mit Schreibrechten; im Inventar-Modal unter <b>Leihen</b> neue Ausleihen für jedes Inventarstück eintragen (optional <b>Kaution</b> und <b>Leihgebühr</b>), offene Leihen beenden oder einzelne Historie-Einträge löschen</li>
<li><b>Leihvertrag / Rückgabe</b> – aus der Leihhistorie druckbare Formulare (alle Inventartypen); Kaution und Leihgebühr nur wenn &gt; 0 €; Entleiher immer so bezeichnet; Mitgliedsnummer bei Mitgliedern, Adressfeld bei Nicht-Mitgliedern; Rückgabe-Checkliste online abhakbar und speicherbar; nach Unterschrift Scan ablegen und in der Historie öffnen. Bei Vereinsmitgliedern endet die Leihe mit dem Austritt, sonst neuer Vertrag als Nicht-Mitglied</li>
' : '').'
</ul>
'
);
